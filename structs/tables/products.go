...
type Product struct {
	...
	Size        structs.Size        `pg:"size" json:"size,omitempty"`                              // optional, use omitempty if nil/empty
	Colors      []structs.Color     `pg:"colors,array" json:"colors,omitempty"`                    // optional, can be empty
	ProductType structs.ProductType `pg:"product_type" json:"product_type,omitempty"`              // optional, use omitempty
